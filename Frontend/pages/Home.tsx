  ...
  return (
    <View style={styles.container}>
     <View >
        ...
        <View>
            <Text style={{ width: 200, height: 40, backgroundColor: 'white',borderRadius: 20,marginTop: 40,justifyContent: 'center',fontSize:25,textAlign:'center',fontWeight:900,marginLeft:70}}>TOP GAMES</Text>
            <View style={styles.box}>
                <View style={{display:'flex',flexDirection:'row',justifyContent:'center',marginTop:20,gap:30}}>
                    <TouchableOpacity onPress={()=>setToggle('freefire')}><TabButton images={freefire}/></TouchableOpacity>
                    <TouchableOpacity onPress={()=>setToggle('pubg')}> <TabButton images={img2}/></TouchableOpacity>
                    <TouchableOpacity onPress={()=>setToggle('cod')}><TabButton images={img3}/></TouchableOpacity>
                </View>
