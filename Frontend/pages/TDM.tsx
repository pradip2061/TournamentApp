      ...
      <View style={styles.modal}>
        ...
        <View style={{marginLeft:40}}>
            ...
            <View style={{display:'flex',flexDirection:'row',gap:100,alignItems:'center',marginTop:20,}}>
                <TouchableOpacity onPress={()=>setMatchDetails((prev)=>({...prev,showDetail:true,match:'TDM'}))} style={ matchDetails.showDetail ?styles.toggle:null}><Text style={ matchDetails.showDetail ? styles.toggleText:styles.toggleTextN}>Clash Squad</Text></TouchableOpacity>
