      ...
      <View style={styles.container}>
        ...
        <View style={styles.methodContainer}>
          <TouchableOpacity onPress={() => setSelectedMethod('eSewa')}>
            <Image source={require('../../assets/esewa.jpg')} style={selectedMethod === 'eSewa' ? styles.selectedIcon : styles.icon} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => setSelectedMethod('Khalti')}>
            <Image source={require('../../assets/khalti.jpg')} style={selectedMethod === 'Khalti' ? styles.selectedIcon : styles.icon} />
          </TouchableOpacity>
        </View>
        ...
        <TouchableOpacity
          style={{width: 190, height: 40, backgroundColor: 'rgb(96,187,70)', alignItems: 'center', justifyContent: 'center', marginTop: 20}}
          onPress={handleDeposite}>
          <Text style={{fontSize: 21, color: 'white'}}>Deposite </Text>
        </TouchableOpacity>
        {selectedImage && <Image source={{uri: selectedImage}} style={{width: 200, height: 200, marginTop: 20, borderRadius: 10}} />}
      </View>
    </ScrollView>
  )
}
