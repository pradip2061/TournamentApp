        ...
        <View style={styles.container}>
            ...
            <View style={styles.topThreeContainer}>
                ...
                <View style={[styles.topPlayerContainer, styles.secondPlace]}>
                    ...
                    <Text style={[styles.score, { color: "#C0C0C0" }]}>{userData?.[1]?.trophy} pts</Text>
                </View>
                
                {/* First Place */}
                <View style={[styles.topPlayerContainer, styles.firstPlace]}>
                    <Image
                        source={{ uri: "https://imgs.search.brave.com/4YhsSPJTo2gK7HvyQsKKpZKybWT53c1JG11kQqQsT3g/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly93d3cu/cG5nbWFydC5jb20v/ZmlsZXMvNS9Dcm93/bi1QTkctUGljLnBu/Zw" }}
                        style={styles.crown}
                    />
                    <Image
                        source={{ uri: "https://cdn-icons-png.flaticon.com/512/3135/3135715.png" }}
                    ...
                    <Text style={[styles.score, { color: "#FFD700" }]}>{userData?.[0]?.trophy} pts</Text>
                </View>
